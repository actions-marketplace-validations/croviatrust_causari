...
| `_headers` | security headers, CSP, caching, feed and JSON content types |
| `_redirects` | vanity URLs, renamed asset paths, `/survival` and `/report` (the latter managed by the generator) |
